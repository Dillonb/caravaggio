...
Cylinder(glm::vec3 c = glm::vec3(0.0f, 0.0f, 0.0f), GLfloat r = 1.0f) :_center{c}, _radius{r},
   ...
   _shininess{10.0f}
   {
      ...
      glm::mat4 smtx = glm::scale(identity, glm::vec3(_radius, _radius, _radius));
      _model_transformation  = glm::translate(smtx, _center);
